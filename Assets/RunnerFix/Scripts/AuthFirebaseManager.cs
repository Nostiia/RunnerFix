...
public class AuthFirebaseManager : MonoBehaviour
{
    ...
    // Login Fields
    [SerializeField] private InputField _loginEmailInput, _loginPasswordInput;
    [SerializeField] private Button _loginButton, _goToRegisterButton;
    [SerializeField] private Text _loginError;

    // Register Fields
    [SerializeField] private InputField _registerEmailInput, _registerUsernameInput, _registerPasswordInput, _registerConfirmPasswordInput;
    [SerializeField] private Button _registerButton, _goToLoginButton;
    [SerializeField] private Text _registerError;
